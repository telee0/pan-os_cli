...
cf = {
    ...
    'duration': '0h4m30s',              # max duration in (? d ? h ? m ? s)
    'iterations': 99999,                  # max number of iterations
    ...
    'tra_file': 'tra-{}.json',          # traffic logs in json format
    'ctx_file': 'ctx-{}.json',
    ...
    'tra_cnt': 5000, # between 1 and 5000
    'tra_apps_top_k': 20,
    'tra_app_filter': [],
    'tra_bins': {
        'bytes': (
...
dp = {
    ...
    'res_util':             r'Resource utilization \(%\) during last (\d+) seconds:',
    'resources':            {
        'se': r'session:',
        'pb': r'packet buffer:',
        'pd': r'packet descriptor:',
        'sw': r'sw tags descriptor:',
    },
    'core':                 'core',
    ...
    'interp':               ["pchip", "spline"][0],  # interpolation algorithm for DP plots
}
